...
?>
       <center>
        <div class="card border-primary border-2 mb-3" style="max-width: 40rem;margin-top: 120px;">
            <div class="card-body">
                <div class="card-title"><h2 style="color: rgb(103, 36, 185); font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif">Import details</h2></div>
                ...
                <form action="./import.php" method="post">
                    <table>
                        ...
                        <tr>
                            <td>No.of pieces imported:</td>
                            <td><input type="text" name="pieces"></td>
                        </tr>
                        <tr>
                            <td> Rate of each pieces:</td>
