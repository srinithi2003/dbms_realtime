...
include('./navbar.php')
?>
  <form action="./dis_one.php" method="post">
    <input type="text" name="pname" placeholder="Enter Medicine name..">
...
$sql = "SELECT * FROM import  left join export on import.pid=export.pid";
